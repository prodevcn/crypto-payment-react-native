    ...
    <SafeAreaView style={styles.main}>
      <ScrollView
        ...
        <View style={_inner.header_bar}>
          ...
          <Text style={_inner.title}>Active Orders</Text>
          <TouchableOpacity style={styles.btn_rounded}>
            <Icon name="calendar" size={20} color={config.dark_theme.third} />
          </TouchableOpacity>
        </View>
        <View style={_inner.row}>
          ...
          <TouchableOpacity style={_inner.day_btn}>
            <Text style={_inner.btn_label}>BUY</Text>
          </TouchableOpacity>
          <TouchableOpacity style={_inner.day_btn}>
            <Text style={_inner.btn_label}>SELL</Text>
          </TouchableOpacity>
        </View>
      </ScrollView>
    </SafeAreaView>
